...
#### Los Angeles caveat: constrained, but not a simple winner

Los Angeles is the clearest split-signal market in this cluster. Zillow places LA on both its 2026 top-10 for-sale list and its summer 2026 hottest-rental list, while Reventure's public comparison calls for **-2.5%** in Los Angeles in 2026 ([Zillow for-sale markets](../external-sources/zillow-hottest-for-sale-markets-2026.md); [Zillow rental markets](../external-sources/zillow-hottest-rental-markets-summer-2026.md); [Reventure forecast splits](../external-sources/reventure-zillow-2026-forecast-splits.md)). The local LA forecast lands between those poles: mostly flat to modestly positive appreciation, roughly **1% to 4%**, with buyers gaining more inventory choice but sellers needing to price to recent closed sales ([Los Angeles forecast](../external-sources/los-angeles-housing-forecast-2026.md)).

The reason LA still belongs in the constrained-market set is supply structure. The local forecast describes inventory as rising but still structurally constrained by zoning, construction costs, and owners holding ultra-low mortgage rates; Brookings' historical supply context says LA housing-stock growth was only **0.5% annually** in the 2010s; and Foot Traffic Ahead places Los Angeles in the top tier of walkable urbanism among large U.S. metros ([Los Angeles forecast](../external-sources/los-angeles-housing-forecast-2026.md); [Brookings supply study](../external-sources/brookings-housing-supply-problem-2025.md); [Foot Traffic Ahead](../external-sources/foot-traffic-ahead-walkable-urbanism-2023.md)). The risk side is operating cost: insurance premiums, property-tax reassessments, and rent-versus-buy pressure make LA a micro-market and carry-cost analysis problem, not a broad metro momentum call ([Los Angeles forecast](../external-sources/los-angeles-housing-forecast-2026.md); [Realtor rent report](../external-sources/realtor-march-2026-rent-report.md)).

**Urban form:** older built-out metros, inner-ring suburbs, smaller legacy cities, and dense neighborhoods with limited greenfield supply. Hartford/Providence/Buffalo/Milwaukee/Chicago-style markets are not winning because they are the fastest-growing population stories; they are winning because replacement supply is difficult and existing homes/rentals are scarce relative to demand. Los Angeles belongs in the same scarcity conversation, but only at neighborhood resolution: its 2026 forecast describes "hundreds of micro-markets," with stronger Westside nodes like Santa Monica, Culver City, Palms/Mar Vista, and Westwood/Century City projected around **+3% to +5%**, while other luxury nodes are lower ([Zillow for-sale markets](../external-sources/zillow-hottest-for-sale-markets-2026.md); [Zillow rental markets](../external-sources/zillow-hottest-rental-markets-summer-2026.md); [Los Angeles forecast](../external-sources/los-angeles-housing-forecast-2026.md)).
